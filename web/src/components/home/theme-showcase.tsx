      ...
      <div className="container mx-auto px-4">
        <Reveal className="text-center mb-12" delay={50}>
          ...
          <p className="text-lg text-base-content/60 max-w-2xl mx-auto">
            Express yourself with beautiful themes
          </p>
        </Reveal>
                ...
                >
                  ...
                  <div className="card-body items-center p-4 text-center">
                    <div className="flex gap-1.5 mb-3">
                      <div
                        className="w-5 h-5 rounded-full border border-base-content/10 shadow-sm"
                    ...
                    {isActive && (
                      <motion.div
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                        className="inline-flex items-center gap-1 badge badge-primary badge-sm mt-1"
                      >
