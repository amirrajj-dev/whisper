...
import { X, Users, Crown, Shield, ShieldCheck, UserPlus, LogOut, Trash2, Gavel } from "lucide-react";
...
import { getParticipantRole, getMembersFromConversation } from "./group-utils";
import type { Role } from "./group-utils";
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        onClose={() => setShowTransferConfirm(null)}
        onConfirm={() => handleTransfer(showTransferConfirm!)}
        title="Transfer Ownership?"
        message="You will no longer be the owner of this group. This action cannot be undone."
